...
const languages: Language[] = [
  {
    name: 'HTML',
    logo: (
      <svg viewBox="0 0 24 24" fill="#E34F26" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
  ...
  },
  {
    name: 'Python',
    logo: (
      <svg viewBox="0 0 24 24" fill="#3776AB" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
  ...
  },
  {
    name: 'JavaScript',
    logo: (
      <svg viewBox="0 0 24 24" fill="#F7DF1E" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
  ...
  },
  {
    name: 'Java',
    logo: (
      <svg viewBox="0 0 24 24" fill="#007396" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
  ...
  <div className="flex flex-wrap   justify-center gap-10">
    {languages.map((language, index) => (
      ...
      >
        ...
        <Badge variant="outline" className=" cursor-pointer py-2 h-20 w-52 flex justify-center items-center">
          <span className="mr-2">
            {language.logo}
          </span>
