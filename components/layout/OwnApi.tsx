...
export default function OwnApi() {
    ...
    const [showPassword, setShowPassword] = useState({ rapid: false, gemini: false });

    const handleSaveRapid = (e: any) => {
        e.preventDefault();
        localStorage.setItem('NEXT_PUBLIC_RAPID_API_KEY', rapidApiKey);
        setSaveStatus(prev => ({ ...prev, rapid: true }));
        setTimeout(() => setSaveStatus(prev => ({ ...prev, rapid: false })), 2000);
    };
    ...
    const handleSaveGemini = (e: any) => {
        ...
        setTimeout(() => setSaveStatus(prev => ({ ...prev, gemini: false })), 2000);
    };
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2 relative">
                                    ...
                                    <Button
                                        ...
                                        className={`w-24 transition-colors ${saveStatus.rapid
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2 relative">
                                    ...
                                    <Button
                                        ...
                                        className={`w-24 transition-colors ${saveStatus.gemini
                                                ? 'bg-green-500 hover:bg-green-600'
                                                : 'bg-primary hover:bg-primary/90'
                                            }`}
                                    >
