...
export const Navbar1: React.FC = () => {
  ...
  return (
    <header className="m-6 shadow-inner bg-opacity-15 w-[90%] md:w-[70%] lg:w-[75%] lg:max-w-screen-xl top-5 mx-auto  border border-secondary rounded-2xl flex justify-between items-center p-2 bg-card">
